              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      const Text('Winch', style: TextStyle(color: ColorController.primaryDarkMode, fontSize: 40, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 15),
                            ...
                            onPressed: state is LoginLoading
                              ...
                              if (formKey.currentState!.validate()) {
                                context.read<LoginBloc>().add(
                                  LoginRequested(email: emailController.text.trim(), password: passwordController.text.trim()),
                                );
                              }
                            },
                            child: state is LoginLoading ? CircularProgressIndicator() : const Text('Login'),
                          );
                        },
                      ),
                      const SizedBox(height: 5),
